...
ESP32-C3 support remains experimental for segmented RMT and is not recommended for new builds. Use it only for simple or low-segment setups; avoid 4-segment builds.
