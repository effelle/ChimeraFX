...
This is particularly practical if you want to use the same effect with different settings. Simply declare the same effect ID with your new parameters and you’re good to go! 
