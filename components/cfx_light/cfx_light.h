...
protected:
  ...
  uint32_t seg_coord_prof_samples_{0};
  uint32_t seg_coord_prof_max_mask_us_{0};
  uint32_t seg_coord_prof_max_loop_us_{0};
  uint32_t seg_coord_prof_max_prep_us_{0};
  uint32_t seg_coord_prof_max_service_us_{0};
  uint32_t seg_coord_prof_max_flush_us_{0};
  uint32_t seg_coord_prof_max_total_us_{0};
  uint64_t seg_coord_prof_total_mask_us_{0};
  uint64_t seg_coord_prof_total_loop_us_{0};
  uint64_t seg_coord_prof_total_prep_us_{0};
  uint64_t seg_coord_prof_total_service_us_{0};
  uint64_t seg_coord_prof_total_flush_us_{0};
  uint64_t seg_coord_prof_total_total_us_{0};
