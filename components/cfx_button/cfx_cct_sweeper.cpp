...
[[maybe_unused]] static const char *color_mode_name(light::ColorMode mode) {
  switch (mode) {
...
[[maybe_unused]] static const char *endpoint_name(CCTEndpoint endpoint) {
  switch (endpoint) {
...
[[maybe_unused]] static const char *short_action_name(
    CCTShortPressAction action) {
  switch (action) {
